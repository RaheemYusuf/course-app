...
class ModelInferenceService:
    ...
    a specified path, and make predictions using the load model.
    ...
    def load_model(self):
        ...
        Raises:
            FileNotFoundError: If the model file not exists at the
            specified dir.
        """
        logger.info(
    ...
    def predict(self, input_parameters: list):
        ...
        return self.model.predict(pd.DataFrame([input_parameters])).tolist()
